...
#**************Resultados de volume*************************************
 ...
 while($c != $tam)							# Ciclo variando pelos diferentes pacientes
	{  								# Inicio do ciclo de pacientes
	 print RELATDADOS $nomes[$c].";".$Vol_L1[$c].";".$Vol_L2[$c].";".$Vol_L3[$c].";".$Vol_L4[$c]."\n";
...
#**************Resultados de conteudo de gordura**********************************
 ...
 print RELATDADOS "name; FAT_L1 (%); ±DP(%); FAT_L2 (%); ±DP(%); FAT_L3 (%); ±DP(%); FAT_L4 (%); ±DP(%)\n";
 $c=0;
 while($c != $tam)
	{  
