...
#**************************************************************************************
  ...
  print"\n\n 1ª etapa de 6) MTR...\n\n";
  $sh-> mincmath(" -const2 1 1.99 -segment ".$NomePaciente."_classified.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_0_licor.mnc");#-bas
  #$sh-> mincmath(" -const2 2 2 -segment ".$NomePaciente."_classified.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_0_background.mnc");
 ...
 $sh-> mincmath(" -const2 3 3.99 -segment ".$NomePaciente."_classified.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_0_white_matter.mnc");
 #Mascara de substância cinzenta
 $sh-> mincmath(" -const2 2 2.99 -segment ".$NomePaciente."_classified.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_0_gray_matter.mnc");
...
#linear
 ...
 $sh-> mincresample(" ".$PrimNome."_".$ano.$mes.$dia."_mt.mnc ".$PrimNome."_".$ano.$mes.$dia."_mttoicm.mnc -like /usr/local/mni/data/mni_autoreg/average_305.mnc -transformation ".$PrimNome."_".$ano.$mes.$dia."_d1_nl.xfm");
 #white===============================================================================
 
 $sh->mritoself(" -close ".$PrimNome."_".$ano.$mes.$dia."_0_d1.mnc.gz /usr/local/mni/data/mni_autoreg/average_305.mnc ".$PrimNome."_".$ano.$mes.$dia."_d1_ln.xfm");
 $sh->mincresample(" ".$PrimNome."_".$ano.$mes.$dia."_0_d1.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_d1_ln.mnc -like /usr/local/mni/data/mni_autoreg/average_305.mnc -transformation ".$PrimNome."_".$ano.$mes.$dia."_d1_ln.xfm");
 
  $sh->minctracc(" -nonlinear -source_lattice -identity -est_center ".$PrimNome."_".$ano.$mes.$dia."_d1_ln.mnc /usr/local/mni/data/mni_autoreg/average_305.mnc ".$PrimNome."_".$ano.$mes.$dia."_mt_parte1.xfm");    
 $sh-> mincresample(" ".$PrimNome."_".$ano.$mes.$dia."_d1_ln.mnc ".$PrimNome."_".$ano.$mes.$dia."_mt_parte1.mnc -like /usr/local/mni/data/mni_autoreg/average_305.mnc -transformation ".$PrimNome."_".$ano.$mes.$dia."_mt_parte1.xfm");

 $sh->minctracc(" -nonlinear -source_lattice -identity -est_center ".$PrimNome."_".$ano.$mes.$dia."_mt_parte1.mnc /usr/local/mni/data/mni_autoreg/average_305.mnc ".$PrimNome."_".$ano.$mes.$dia."_mt_parte3.xfm");    
 $sh-> mincresample(" ".$PrimNome."_".$ano.$mes.$dia."_mt_parte1.mnc ".$PrimNome."_".$ano.$mes.$dia."_mt_parte3.mnc -like /usr/local/mni/data/mni_autoreg/average_305.mnc -transformation ".$PrimNome."_".$ano.$mes.$dia."_mt_parte3.xfm");
 
 $sh->minctracc(" -nonlinear -source_lattice -identity -est_center ".$PrimNome."_".$ano.$mes.$dia."_mt_parte3.mnc /usr/local/mni/data/mni_autoreg/average_305.mnc ".$PrimNome."_".$ano.$mes.$dia."_mt_parte4.xfm");    

 $sh-> mincresample(" ".$PrimNome."_".$ano.$mes.$dia."_seg_white_mt.mnc ".$PrimNome."_".$ano.$mes.$dia."_mtwhitetoicm.mnc -like /usr/local/mni/data/mni_autoreg/average_305.mnc -transformation ".$PrimNome."_".$ano.$mes.$dia."_mt_parte4.xfm");
 $sh-> mincresample(" ".$PrimNome."_".$ano.$mes.$dia."_seg_gray_mt.mnc ".$PrimNome."_".$ano.$mes.$dia."_mtgraytoicm.mnc -like /usr/local/mni/data/mni_autoreg/average_305.mnc -transformation ".$PrimNome."_".$ano.$mes.$dia."_mt_parte4.xfm"); 
 print "\n\n".$pastas[0]."\n\n";
...
sub analise_global
{
 ...
 $sh->minccalc(" -expfile /usr/local/mrs/scripts/average.exp ".$linha_mtr." mapa_medio_MTR.mnc");
 ...
 $sh->minccalc(" -expfile /usr/local/mrs/scripts/average.exp ".$linha_white." mapa_medio_white_matter.mnc");
 
 @lista_de_arq_gray = glob("./*_mtgraytoicm.mnc");
 $linha_gray = join(" ",@lista_de_arq_gray);
 #$sh->mincaverage(" -sdfile DesvPad_white_matter.mnc ".$linha_white." mapa_medio_white_matter.mnc");
 $sh->minccalc(" -expfile /usr/local/mrs/scripts/average.exp ".$linha_gray." mapa_medio_gray_matter.mnc");
