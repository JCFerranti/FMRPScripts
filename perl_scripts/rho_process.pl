...
#************************Media em Núcleo Pulposo 5********************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 1 -floor 10 -ceil 150 > volume1.txt");
...
#************************Desvio padrao em Núcleo Pulposo 5*****************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 1 -floor 10 -ceil 150 > volume1.txt");
...
#************************Media em Anulo Fibroso Posterior 5**************************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 2 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em Anulo Fibroso Posterior Vértebra 5*********************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 2 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Anulo Fibroso Anterior 5*********************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 3 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em ANulo Fibroso Anterior 5*****************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 3 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Núcleo Pulposo 4********************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 4 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em Núcleo Pulposo 4*****************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 4 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Anulo Fibroso Posterior 4**************************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 5 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em Anulo Fibroso Posterior Vértebra 4*********************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 5 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Anulo Fibroso Anterior 4*********************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 6 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em ANulo Fibroso Anterior 4*****************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 6 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Núcleo Pulposo 3********************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 7 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em Núcleo Pulposo 3*****************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 7 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Anulo Fibroso Posterior 3**************************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 8 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em Anulo Fibroso Posterior Vértebra 3*********************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 8 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Anulo Fibroso Anterior 3*********************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 9 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em ANulo Fibroso Anterior 3*****************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 9 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Núcleo Pulposo 2********************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 10 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em Núcleo Pulposo 2*****************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 10 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Anulo Fibroso Posterior 2**************************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 11 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em Anulo Fibroso Posterior Vértebra 2*********************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 11 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Anulo Fibroso Anterior 2*********************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 12 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
 $AFA2_mean = substr($temp1,0,rindex($temp1," "));
 print "AFA2_mean: ".$AFA5_mean."\n";
 $sh->rm("volume1.txt");
 push(@AFA2_mean,$AFA2_mean);
#************************Desvio padrao em ANulo Fibroso Anterior 2*****************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 12 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Núcleo Pulposo 1********************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 13 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
 $NP1_mean = substr($temp1,0,rindex($temp1," "));
 print "NP1_mean: ".$NP5_mean."\n";
 $sh->rm("volume1.txt");
 push(@NP1_mean,$NP1_mean);
#************************Desvio padrao em Núcleo Pulposo 1*****************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 13 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Anulo Fibroso Posterior 1**************************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 14 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em Anulo Fibroso Posterior Vértebra 1*********************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 14 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
...
#************************Media em Anulo Fibroso Anterior 1*********************
 $sh->mincstats(" -mean ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 15 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
...
#************************Desvio padrao em ANulo Fibroso Anterior 1*****************
 $sh->mincstats(" -stddev ".$PrimNome."_process.mnc.gz -mask ".$lbl."_res.mnc.gz -mask_binvalue 15 -floor 10 -ceil 150 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
