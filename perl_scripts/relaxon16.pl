...
#$sh->mincwindow(" relaxosj.mnc relaxom.mnc 10 200");#cornea
$sh->mincwindow(" relaxosj.mnc relaxom.mnc 10 2000");

#$sh->mincmath(" -segment -const2 10 100 relaxosj.mnc");

print "\nGerando a imagem de Densdidade de protons...\n";
