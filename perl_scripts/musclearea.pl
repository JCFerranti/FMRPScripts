...
# Nivel L5S1 ESQUERDO #########################Função que segmenta o musculo e a gordura e calcula as áreas ############################
 ...
 $sh-> mincmath(" -const2 ".$min." ".$zoca." -segment ".$NomePaciente."_seg_lbl1_axt1.mnc ".$NomePaciente."_lbl1_muscle.mnc");
 #print"\n\n mincmath( -const2 0 ".$thr." -segment ".$NomePaciente."_seg_lbl1_axt1.mnc ".$NomePaciente."_lbl1_fat.mnc)";
 $sh-> mincmath(" -const2 ".$zoca." ".$max." -segment ".$NomePaciente."_seg_lbl1_axt1.mnc ".$NomePaciente."_lbl1_fat.mnc");
...
######### NIVEL L5S1 DIREITO ###################################################################
 ...
 $sh-> mincmath(" -const2 ".$min." ".$zoca." -segment ".$NomePaciente."_seg_lbl2_axt1.mnc ".$NomePaciente."_lbl2_muscle.mnc");
 #print"\n\n mincmath( -const2 0 ".$thr." -segment ".$NomePaciente."_seg_lbl1_axt1.mnc ".$NomePaciente."_lbl1_fat.mnc)";
 $sh-> mincmath(" -const2 ".$zoca." ".$max." -segment ".$NomePaciente."_seg_lbl2_axt1.mnc ".$NomePaciente."_lbl2_fat.mnc");
 #print"\n\n mincmath( -const2 ".$thr." ".$max." -segment ".$NomePaciente."_seg_lbl1_axt1.mnc ".$NomePaciente."_lbl1_fat.mnc";
...
#########NIVEL L4/L5 ESQUERDO ###################################################################
 ...
 $sh-> mincmath(" -const2 ".$min." ".$zoca." -segment ".$NomePaciente."_seg_lbl3_axt1.mnc ".$NomePaciente."_lbl3_muscle.mnc");
 #print"\n\n mincmath( -const2 0 ".$thr." -segment ".$NomePaciente."_seg_lbl3_axt1.mnc ".$NomePaciente."_lbl3_fat.mnc)";
 $sh-> mincmath(" -const2 ".$zoca." ".$max." -segment ".$NomePaciente."_seg_lbl3_axt1.mnc ".$NomePaciente."_lbl3_fat.mnc");
...
#########NIVEL L4/L5 DIREITO ###################################################################
 ...
 $sh-> mincmath(" -const2 ".$min." ".$zoca." -segment ".$NomePaciente."_seg_lbl4_axt1.mnc ".$NomePaciente."_lbl4_muscle.mnc");
 $sh-> mincmath(" -const2 ".$zoca." ".$max." -segment ".$NomePaciente."_seg_lbl4_axt1.mnc ".$NomePaciente."_lbl4_fat.mnc");
...
#########NIVEL L3/L4 ESQUERDO ###################################################################
 ...
 $sh-> mincmath(" -const2 ".$min." ".$zoca." -segment ".$NomePaciente."_seg_lbl5_axt1.mnc ".$NomePaciente."_lbl5_muscle.mnc");
 $sh-> mincmath(" -const2 ".$zoca." ".$max." -segment ".$NomePaciente."_seg_lbl5_axt1.mnc ".$NomePaciente."_lbl5_fat.mnc");
...
#########NIVEL L3/L4 DIREITO ###################################################################
 ...
 $sh-> mincmath(" -const2 ".$min." ".$zoca." -segment ".$NomePaciente."_seg_lbl6_axt1.mnc ".$NomePaciente."_lbl6_muscle.mnc");
 $sh-> mincmath(" -const2 ".$zoca." ".$max." -segment ".$NomePaciente."_seg_lbl6_axt1.mnc ".$NomePaciente."_lbl6_fat.mnc");
