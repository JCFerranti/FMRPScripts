...
#linear
 ...
 print"\n\n Gerando Difusão...\n\n";
     ...
     #do "/usr/local/mni/scripts/Dparaeperp_main.pl";
     #&main; 
	 ###############################################################
...
#Subtsancia branca
 $sh->res(" ".$PrimNome."_".$ano.$mes.$dia."_0_white_matter ".$PrimNome."_relaxo ");
 $sh->mincstats(" -mean ".$PrimNome."_relaxo.mnc.gz -mask ".$PrimNome."_".$ano.$mes.$dia."_0_white_matter_res.mnc.gz -mask_binvalue 1 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
 $media_relaxo_WM = substr($temp1,0,rindex($temp1," "));
 $sh->rm("volume1.txt");
 
 $sh->mincstats(" -stddev ".$PrimNome."_relaxo.mnc.gz -mask ".$PrimNome."_".$ano.$mes.$dia."_0_white_matter_res.mnc.gz -mask_binvalue 1 > volume1.txt");
 ...
 #Subtsancia cinzenta
 $sh->res(" ".$PrimNome."_".$ano.$mes.$dia."_0_gray_matter ".$PrimNome."_relaxo ");
 $sh->mincstats(" -mean ".$PrimNome."_relaxo.mnc.gz -mask ".$PrimNome."_".$ano.$mes.$dia."_0_gray_matter_res.mnc.gz -mask_binvalue 1 > volume1.txt");
 $tag1 = $sh->grep(" Mean volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+15);
 $media_relaxo_GM = substr($temp1,0,rindex($temp1," "));
 $sh->rm("volume1.txt");
 
 $sh->mincstats(" -stddev ".$PrimNome."_relaxo.mnc.gz -mask ".$PrimNome."_".$ano.$mes.$dia."_0_gray_matter_res.mnc.gz -mask_binvalue 1 > volume1.txt");
 $tag1 = $sh->grep(" Stddev volume1.txt");
 $temp1 = substr($tag1,rindex($tag1,":")+13);
