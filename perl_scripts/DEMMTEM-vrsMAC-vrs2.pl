...
open(RELATDADOS, "> dados_Relaxo_MT_WM.txt");
    $tam =@nomes;
	print RELATDADOS " ,Relaxo, , MT \n";
    print RELATDADOS "nome,Media,Desvio Padrão, Media, Desvio Padrão \n";
	$c=0;
	while($c != $tam)
	{  
	   print RELATDADOS $nomes[$c].",".$mediasrelaxoWM[$c].",".$desviorelaxoWM[$c].",".$mediasmtWM[$c].",".$desviomtWM[$c]."\n";
	  $c=$c+1;
	}
open(RELATDADOS, "> dados_Relaxo_MT_GM.txt");
	...
	while($c != $tam)
	{  
	   print RELATDADOS $nomes[$c].",".$mediasrelaxoGM[$c].",".$desviorelaxoGM[$c].",".$mediasmtGM[$c].",".$desviomtGM[$c]."\n";
	  $c=$c+1;
	}
...
open(RELATDADOS, "> dados_Relaxo_MT_Lt1.txt");
	...
	while($c != $tam)
	{  
	   print RELATDADOS $nomes[$c].",".$mediasrelaxoLt1[$c].",".$desviorelaxoLt1[$c].",".$mediasmtLt1[$c].",".$desviomtLt1[$c]."\n";
	  $c=$c+1;
	}
...
open(RELATDADOS, "> dados_Relaxo_MT_Lt2.txt");
	...
	while($c != $tam)
	{  
	   print RELATDADOS $nomes[$c].",".$mediasrelaxoLt2[$c].",".$desviorelaxoLt2[$c].",".$mediasmtLt2[$c].",".$desviomtLt2[$c]."\n";
	  $c=$c+1;
	}
...
#**************************************************************************************
 ...
 $ruido = ($max+$min)/2;
  $sh->mritoself(" -clobber -close ".$PrimNome."_".$ano.$mes.$dia."_0_d2.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_0_d1.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_d2tod1.xfm");
  $sh->mincresample(" -clobber ".$PrimNome."_".$ano.$mes.$dia."_0_d2.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_d2tod1.mnc -like ".$PrimNome."_".$ano.$mes.$dia."_0_d1.mnc.gz -transformation ".$PrimNome."_".$ano.$mes.$dia."_d2tod1.xfm");
  ...
  $sh->mincmath(" -clobber -pd -const ".$ruido." ".$PrimNome."_".$ano.$mes.$dia."_0_d1.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_d2tod1.mnc ".$PrimNome."_".$ano.$mes.$dia."_mt.mnc");
 
 print"\n\n 2ª etapa de 6) Obtendo máscaras de substância branca e da substância cinzenta...\n\n";
 $sh-> mincmath(" -clobber -const2 4 4 -segment ".$PrimNome."_".$ano.$mes.$dia."_0_2003_02_14_bayes.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_0_white_matter.mnc");
 #Mascara de substância cinzenta
 $sh-> mincmath(" -clobber -const2 3 3 -segment ".$PrimNome."_".$ano.$mes.$dia."_0_2003_02_14_bayes.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_0_gray_matter.mnc");
 $sh-> mincmath(" -clobber -const2 5 5 -segment ".$PrimNome."_".$ano.$mes.$dia."_0_2003_02_14_bayes.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_0_lesoes_t1.mnc");
 $sh-> mincmath(" -clobber -const2 6 6 -segment ".$PrimNome."_".$ano.$mes.$dia."_0_2003_02_14_bayes.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_0_lesoes_t2.mnc");
 # erosão
 print"\n\n 3ª etapa de 6) Erodindo máscaras...\n\n";
 $sh->mincmorph(" -clobber -erosion ".$PrimNome."_".$ano.$mes.$dia."_0_white_matter.mnc ".$PrimNome."_".$ano.$mes.$dia."_erosion_white_matter.mnc");
 $sh->mincmorph(" -clobber -erosion ".$PrimNome."_".$ano.$mes.$dia."_0_gray_matter.mnc ".$PrimNome."_".$ano.$mes.$dia."_erosion_gray_matter.mnc");
 
 #coregistro 
 $sh->gzip(" -f ".$PrimNome."_".$ano.$mes.$dia."_0_white_matter.mnc");
 $sh->gzip(" -f ".$PrimNome."_".$ano.$mes.$dia."_0_gray_matter.mnc");
 $sh->gzip(" -f ".$PrimNome."_".$ano.$mes.$dia."_mt.mnc");
 ...
 $sh->mincmath(" -clobber -mult ".$PrimNome."_".$ano.$mes.$dia."_mt.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_0_white_matter_res.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_seg_white_mt1.mnc");   
 $sh->mincmath(" -clobber -mult ".$PrimNome."_".$ano.$mes.$dia."_mt.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_0_gray_matter_res.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_seg_gray_mt1.mnc");
 $sh->gunzip(" -f ".$PrimNome."_".$ano.$mes.$dia."_0_white_matter.mnc.gz");
 $sh->gunzip(" -f ".$PrimNome."_".$ano.$mes.$dia."_0_gray_matter.mnc.gz");
 $sh->gunzip(" -f ".$PrimNome."_".$ano.$mes.$dia."_0_lesoes_t1.mnc.gz");
 $sh->gunzip(" -f ".$PrimNome."_".$ano.$mes.$dia."_0_lesoes_t2.mnc.gz");
 $sh->gunzip(" -f ".$PrimNome."_".$ano.$mes.$dia."_mt.mnc.gz");
 #extração de dados e o histograma do MT das substância cinzenta e branca
 print"\n\n 6ª etapa  de 6) Extraindo informações das imagens...\n\n";
 $sh->mincstats(" -clobber -integer_histogram -histogram ".$PrimNome."_".$ano.$mes.$dia."_histogram_white_matter.txt ".$PrimNome."_".$ano.$mes.$dia."_seg_white_mt1.mnc > ".$PrimNome."_".$ano.$mes.$dia."_info_white_matter.txt");
 $sh->mincstats(" -clobber -integer_histogram -histogram ".$PrimNome."_".$ano.$mes.$dia."_histogram_gray_matter.txt ".$PrimNome."_".$ano.$mes.$dia."_seg_gray_mt1.mnc > ".$PrimNome."_".$ano.$mes.$dia."_info_gray_matter.txt");
 #*************************************************************
 $sh->mritoself(" -clobber -close ".$PrimNome."_".$ano.$mes.$dia."_mt.mnc ".$PrimNome."_".$ano.$mes.$dia."_erosion_white_matter.mnc ".$PrimNome."_".$ano.$mes.$dia."_mttoerW.xfm");
 $sh->mritoself(" -clobber -close ".$PrimNome."_".$ano.$mes.$dia."_mt.mnc ".$PrimNome."_".$ano.$mes.$dia."_erosion_gray_matter.mnc ".$PrimNome."_".$ano.$mes.$dia."_mttoerG.xfm"); 
 $sh->mincresample(" -clobber ".$PrimNome."_".$ano.$mes.$dia."_mt.mnc ".$PrimNome."_".$ano.$mes.$dia."_mttoerw.mnc -like ".$PrimNome."_".$ano.$mes.$dia."_erosion_white_matter.mnc -transformation ".$PrimNome."_".$ano.$mes.$dia."_mttoerW.xfm");
 $sh->mincresample(" -clobber ".$PrimNome."_".$ano.$mes.$dia."_mt.mnc ".$PrimNome."_".$ano.$mes.$dia."_mttoerg.mnc -like ".$PrimNome."_".$ano.$mes.$dia."_erosion_gray_matter.mnc -transformation ".$PrimNome."_".$ano.$mes.$dia."_mttoerG.xfm");
 #segmentação
 print"\n\n 5ª etapa  de 6) Segmentando...\n\n";
 $sh->mincmath(" -clobber -mult ".$PrimNome."_".$ano.$mes.$dia."_erosion_white_matter.mnc ".$PrimNome."_".$ano.$mes.$dia."_mttoerw.mnc ".$PrimNome."_".$ano.$mes.$dia."_seg_white_mt.mnc");   
 $sh->mincmath(" -clobber -mult ".$PrimNome."_".$ano.$mes.$dia."_erosion_gray_matter.mnc ".$PrimNome."_".$ano.$mes.$dia."_mttoerg.mnc ".$PrimNome."_".$ano.$mes.$dia."_seg_gray_mt.mnc");
 #*************************************************************
 #linear
 $sh->mritotal(" -clobber -verbose -nonlinear ".$PrimNome."_".$ano.$mes.$dia."_0_d1.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_d1_nl.xfm");
 
 $sh-> mincresample(" -clobber ".$PrimNome."_".$ano.$mes.$dia."_mt.mnc ".$PrimNome."_".$ano.$mes.$dia."_mttoicm.mnc -like /usr/local/mni/share/mni_autoreg/average_305.mnc -transformation ".$PrimNome."_".$ano.$mes.$dia."_d1_nl.xfm");
 #white===============================================================================
 
 $sh->mritoself(" -clobber -close ".$PrimNome."_".$ano.$mes.$dia."_0_d1.mnc.gz /usr/local/mni/share/mni_autoreg/average_305.mnc ".$PrimNome."_".$ano.$mes.$dia."_d1_ln.xfm");
 $sh->mincresample(" -clobber ".$PrimNome."_".$ano.$mes.$dia."_0_d1.mnc.gz ".$PrimNome."_".$ano.$mes.$dia."_d1_ln.mnc -like /usr/local/mni/share/mni_autoreg/average_305.mnc -transformation ".$PrimNome."_".$ano.$mes.$dia."_d1_ln.xfm");
...
{chdir("analise_da_amostra");
 ...
 print RELATDADOS "média = $media\n";
 print RELATDADOS "desvio_padrão = $stddev\n";
 #Mapa z-score
