	...
	{ 	$marcador=0;
		...
		while($marcador != $teste2 )
			...
			$tag4 = $sh->grep(" dicom_0x0008:el_0x103E mincheader.txt");
				  ...
				  print "\n\n TIPO:$tipo \n\n";
				#d1 e d2 
			 if(sprintf("%.3f",$repetition) == 0.023 || sprintf("%.3f",$repetition) == 0.022 && $var eq "SP")
										...
										{ print"\n\n\ veja o nome do arquivo para DUAL:".$vector4[0]."\n\n";
											   ...
											   {		 
												...
												{ print"\n\n\ veja o nome do arquivo para dmap:".$vector4[0]."\n\n";
																	...
																	print"\n\n ADC ".$file_dif."\n\n";
																	$sh->mv(" ".$dmapname." ".$NomePaciente."_".$ano.$mes.$dia."_".$idmap."_adc.mnc");
																	$sh->gzip(" ".$NomePaciente."_".$ano.$mes.$dia."_".$idmap."_adc.mnc");
																	$idmap = $idmap + 1;	 
												} else
												{		 
		...
		$sh->rm(" mincheader.txt");
			 ...
			 while($verif != $tamV)
			{
				 ...
				 $e1name1 = substr($file_e1,0,$stopp);
				 print"\n\n E4 :".$file_e1."\n\n";
				 $sh->mv(" $e1name1 ".$NomePaciente."_".$ano.$mes.$dia."_".$ind."_e5.mnc");
				 $sh->gzip(" ".$NomePaciente."_".$ano.$mes.$dia."_".$ind."_e5.mnc");
