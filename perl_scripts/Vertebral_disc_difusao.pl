...
#**************Resultados de ADC*************************************
 ...
 while($c != $tam)
	{  
	 ...
	 print RELATDADOS $nomes[$c].";".$ADC_DL5S1_mean[$c].";".$ADC_DL5S1_DP[$c].";".$ADC_DL4L5_mean[$c].";".$ADC_DL4L5_DP[$c].";".$ADC_DL3L4_mean[$c].";".$ADC_DL3L4_DP[$c].";".$ADC_DL2L3_mean[$c].";".$ADC_DL2L3_DP[$c].";".$DADC_L1L2_mean[$c].";".$DADC_L1L2_DP[$c]."\n";
	 $c=$c+1;
	}
