...
#**************Resultados de ADC*************************************
 ...
 open(RELATDADOS, "> Disc_ADC.txt");				# Abertura de arquivo para salvar dados de ADC
 print RELATDADOS "name; ADC_DL5S1 (mm²/s); ±DP(mm²/s); ADC_DL4L5 (mm²/s); ±DP(mm²/s); ADC_DL3L4 (mm²/s); ±DP(mm²/s); ADC_DL2L3 (mm²/s); ±DP(mm²/s); ADC_DL1L2 (mm²/s); ±DP(mm²/s)\n";
 $c=0;
 print "Nomes: ".$nomes."\n"; 
 while($c != $tam)
	{  
         print "Escrevendo resultados: \n"; 
	 print RELATDADOS $nomes[$c].";".$ADC_DL5S1_mean[$c].";".$ADC_DL5S1_DP[$c].";".$ADC_DL4L5_mean[$c].";".$ADC_DL4L5_DP[$c].";".$ADC_DL3L4_mean[$c].";".$ADC_DL3L4_DP[$c].";".$ADC_DL2L3_mean[$c].";".$ADC_DL2L3_DP[$c].";".$ADC_DL1L2_mean[$c].";".$ADC_DL1L2_DP[$c]."\n";
	 $c=$c+1;
	}
