...
###############################################################
#Autor:Rafael Reis, Gustavo Bonugli
...
#************************Geração do mapa de conteudo de gordura***************************************************
 ...
 $sh->mincmath(" -double -div  subtracao.mnc ".$vector[1]." div.mnc");	# Divisao da subtracao e a soma
 $sh->mincmath(" -double -mult -const 50  div.mnc fat_map1.mnc");	# Multiplicacao por 100 para levar a percentagem, criando o mapa em fat_map.mnc
 ...
 $sh->rm("fat_map1.mnc");					       # Elimina o arquivo fat_map1.mnc
