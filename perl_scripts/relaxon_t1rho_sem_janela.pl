...
while($kk != 0)
	...
	$xs = $xs + $TE;
	print "\n O valor do XS tempo de echo $resposta é: $xs ...\n";
	$x2s = $x2s + $TE*$TE;
	print "\n O valor do x2s tempo de echo $resposta é: $x2s ...\n";
	$EcNu = $EcNu + 1;
	$kk= $kk - 1;
	$resposta = $resposta + 1;
	}
...
$sh->mincmath(" -double -invert -constant ".$Numer." Denom.mnc relaxom.mnc");
...
#$sh->mincwindow(" relaxosj.mnc relaxom.mnc 0 1000");
