...
#########NIVEL L4/L5 ESQUERDO ###################################################################
 ...
 #segmentar a imagem com o label
 $sh-> mincmath(" -const2 3 3.99 -segment ".$classif." ".$NomePaciente."_lbl3.mnc");
...
#########NIVEL L4/L5 DIREITO ###################################################################
 ...
 #segmentar a imagem com o label
 #print"Segmentação"
 $sh-> mincmath(" -const2 4 4.99 -segment ".$classif." ".$NomePaciente."_lbl4.mnc");
...
#########NIVEL L3/L4 ESQUERDO ###################################################################
 ...
 #segmentar a imagem com o label
 #print"Segmentação"
 $sh-> mincmath(" -const2 5 5.99 -segment ".$classif." ".$NomePaciente."_lbl5.mnc");
...
#########NIVEL L3/L4 DIREITO ###################################################################
 ...
 #segmentar a imagem com o label
 #print"Segmentação"
 $sh-> mincmath(" -const2 6 6.99 -segment ".$classif." ".$NomePaciente."_lbl6.mnc");
