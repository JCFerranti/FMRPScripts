...
while($contador != $teste)
{
  ...
  {  
	...
	$sh->mri_convert(" --in_type mgz -i ./".$NomePasta."/mri/aparc+aseg.mgz --out_type minc -o ".$NomePasta."_aparc+aseg.mnc");  
	$sh->mri_convert(" --in_type mgz -i ./".$NomePasta."/mri/wmparc.mgz --out_type minc -o ".$NomePasta."_wmparc.mnc");  
  }   
